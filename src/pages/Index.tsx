...
const ORDER_URL =
  "https://functions.poehali.dev/119cd058-54f2-4013-b08c-9573f9d6d7c6";
...
const HEROES = [
  {
    ...
    emotion: "тревога",
    description:
      "Создаёт уют, защищает пространство от хаоса и возвращает чувство спокойствия.",
    power: "Стабильность",
    price: 777,
    accentColor: "#8a6a3a",
    emoji: "🏡",
    ...
    icon: "Crown",
    image:
      "https://cdn.poehali.dev/projects/c6d9f74d-4013-41c8-8d30-08b98562c318/bucket/fa9f9809-1b50-455d-8397-8913b034b37c.PNG",
  },
  {
    id: 2,
    name: "Айрея",
    ...
    emotion: "запутался",
    description:
      "Помогает отпустить лишние мысли, вдохнуть свободно и почувствовать внутреннюю ясность.",
    power: "Свобода",
    price: 777,
    accentColor: "#4a7aaa",
    emoji: "🌬️",
    ...
    icon: "Wind",
    image:
      "https://cdn.poehali.dev/projects/c6d9f74d-4013-41c8-8d30-08b98562c318/bucket/319faa4f-6ce0-4428-a06d-bb5dddde2c0d.PNG",
  },
  {
    id: 3,
    name: "Нерелий",
    ...
    icon: "Heart",
    image:
      "https://cdn.poehali.dev/projects/c6d9f74d-4013-41c8-8d30-08b98562c318/bucket/529e0c78-299f-4c85-8e89-9bf96f180f76.PNG",
  },
  {
    id: 4,
    name: "Листорог",
    ...
    emotion: "усталость",
    description:
      "Даёт силу двигаться вперёд даже тогда, когда не видно дороги.",
    power: "Рост",
    price: 777,
    accentColor: "#5a8a45",
    emoji: "🌱",
    ...
    icon: "Leaf",
    image:
      "https://cdn.poehali.dev/projects/c6d9f74d-4013-41c8-8d30-08b98562c318/bucket/d6533291-db2e-466a-9f90-e1a347992a37.PNG",
  },
  {
    id: 5,
    name: "Древлин",
    ...
    icon: "TreePine",
    image:
      "https://cdn.poehali.dev/projects/c6d9f74d-4013-41c8-8d30-08b98562c318/bucket/c78f9b9e-bdd5-4670-9a60-76b56d858e60.PNG",
  },
  {
    id: 6,
    name: "Игнитрис",
    ...
    icon: "Flame",
    image:
      "https://cdn.poehali.dev/projects/c6d9f74d-4013-41c8-8d30-08b98562c318/bucket/e043ad8d-7cb2-4a69-852f-8b98438ec0d1.PNG",
  },
];
...
export default function Index() {
  ...
  const addToCart = (hero: (typeof HEROES)[0]) => {
    setCart((prev) => {
      ...
      if (ex)
        return prev.map((i) =>
          i.id === hero.id ? { ...i, qty: i.qty + 1 } : i,
        );
      return [
        ...prev,
        { id: hero.id, name: hero.name, price: hero.price, qty: 1 },
      ];
    });
  };
  ...
  return (
    <div className="min-h-screen" style={{ background: "hsl(150, 25%, 5%)" }}>
      ...
      >
        ...
        >
          <span
            className="font-heading text-xl tracking-[0.15em]"
            style={{
      ...
      {cartOpen && (
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          />
          <div
            className="relative w-full max-w-md h-full flex flex-col overflow-y-auto"
            style={{
              ...
              <>
                <div className="flex-1 p-6 space-y-4">
                  {cart.map((item) => (
                    <div
                      key={item.id}
                      className="flex items-center gap-4 p-4 rounded-xl forest-card"
                    >
                      <div
      ...
      <main className="pt-16">
              ...
              <div className="container max-w-7xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-16 items-center">
                <div className="space-y-8">
                  <div className="animate-fade-in-up">
                    ...
                    >
                      У каждого есть <br />
                      <em className="gold-shimmer not-italic">
                        свой хранитель
                      </em>
                    </h1>
                  </div>
                  ...
                  <p
                    className="animate-fade-in-up delay-200 text-base leading-relaxed max-w-md"
                    style={{
                      color: "hsl(40,20%,65%)",
                      fontFamily: "'Golos Text', sans-serif",
                    }}
                  >
                    Little Spirits. Для детей - первый язык чувств.
                    <br />
                    Для взрослых - напоминание о себе.
                  </p>
                ...
                <div className="relative animate-fade-in delay-300 flex items-center justify-start overflow-visible">
                  <div className="relative z-10 animate-float">
                    <img
                      ...
                      style={{
                        ...
                        height: 300,
                        maskImage:
                          "radial-gradient(ellipse 75% 75% at 50% 50%, black 45%, transparent 80%)",
                        WebkitMaskImage:
                          "radial-gradient(ellipse 75% 75% at 50% 50%, black 45%, transparent 80%)",
                      }}
                    />
                  ...
                  <div
                    className="hidden md:block absolute bottom-6 right-6 z-20 px-4 py-2 rounded-xl text-xs backdrop-blur-md"
                    style={{
              ...
              <div className="container max-w-6xl mx-auto">
                <div className="text-center mb-16 scroll-reveal">
                  ...
                  >
                    Мы все чувствуем.
                    <br />
                    Просто не всегда можем объяснить.
                  </h2>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-12 items-center">
                  ...
                  <div className="scroll-reveal delay-200 text-center space-y-6">
                    ...
                    <div className="space-y-3">
                      {[
                        "Тревогу (Мне тревожно)",
                        "Усталость(Мне грустно)",
                        "Растеренность(Мне страшно)",
                        "Одиночество(Мне нужна поддержка)",
                      ].map((e) => (
                        <p
                          key={e}
                  ...
                  <div className="scroll-reveal delay-400">
                    <div className="p-8 rounded-2xl forest-card text-center">
                      ...
                      >
                        Но у каждого есть момент, когда нужен свой хранитель:
                      </p>
                      <p
                        className="text-2xl"
                        style={{
                      ...
                      >
                        ...
                        >
                          Для детей игрушка становится языком эмоций —
                          безопасным и понятным. Взрослым помогает вернуться к
                          себе - мягко, через образ и смысл.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  {[
                    {
                      n: "01",
                      title: "Выбери героя",
                      text: "По состоянию или знаку зодиака. Пройди тест или доверься интуиции.",
                      icon: "Compass",
                    },
                    {
                      n: "02",
                      title: "Играй и проживай",
                      text: "Через героя ребёнок понимает свои чувства безопасно и с интересом.",
                      icon: "Heart",
                    },
                    {
                      n: "03",
                      title: "Расти вместе",
                      text: "Хранители становятся частью важных разговоров дома. Это работает годами.",
                      icon: "TreePine",
                    },
                  ].map((step, i) => (
                    <div
                      key={step.n}
                      className={`scroll-reveal delay-${i * 200} p-8 rounded-2xl forest-card text-center group`}
                    >
                      <div
                        className="w-14 h-14 rounded-full mx-auto mb-6 flex items-center justify-center transition-all group-hover:scale-110"
                        style={{
                          background: "rgba(212,175,55,0.08)",
            ...
            <section className="py-24 px-6">
              <div className="container max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                  {HEROES.map((hero, i) => (
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(160deg, hsl(35,18%,14%), hsl(35,12%,11%))",
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          background: `linear-gradient(135deg, ${hero.accentColor}10 0%, transparent 100%)`,
                        }}
                      >
                        <p
                ...
                <div className="text-center mt-12 scroll-reveal">
                  <button
                    onClick={() => navigate("catalog")}
                    className="btn-gold px-10 py-4 rounded-xl text-sm font-medium tracking-wide"
                  >
                    Весь каталог
                  </button>
                </div>
              ...
              <div className="container max-w-5xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  {[
                    {
                      title: "Для детей",
                      text: "Инструмент эмоционального интеллекта. Помогает называть и проживать чувства через игру.",
                      icon: "Baby",
                      accent: "#5ba8a0",
                    },
                    {
                      title: "Для родителей",
                      text: "Мост для разговоров о сложном. Когда слова не находятся — хранитель находит их за вас.",
                      icon: "Users",
                      accent: "#c8a840",
                    },
                    {
                      title: "Для взрослых",
                      text: "Символ внутренней опоры. Напоминание о своём настоящем «я» в моменты потери себя.",
                      icon: "Sparkles",
                      accent: "#8a5ab8",
                    },
                  ].map((item, i) => (
                    <div
                      key={item.title}
                      className={`scroll-reveal delay-${i * 200} p-8 rounded-2xl text-center`}
                      style={{
            ...
            <section className="py-24 px-6">
              <div className="container max-w-3xl mx-auto text-center scroll-reveal">
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, hsl(150,20%,8%), hsl(150,18%,10%))",
                ...
                >
                  ...
                  <button
                    onClick={() => navigate("catalog")}
                    className="btn-gold px-10 py-4 rounded-xl font-medium"
                  >
                    Успеть купить
                  </button>
                </div>
          ...
          <section className="py-24 px-6 min-h-screen">
            <div className="container max-w-6xl mx-auto">
              <div className="text-center mb-20 animate-fade-in-up">
                ...
                >
                  Шесть уникальных существ, каждое из которых несёт свою эмоцию
                  и историю
                </p>
              </div>
                  ...
                  >
                    <div className={i % 2 === 1 ? "md:order-2" : ""}>
                      <div
                        ...
                        style={{
                          background: `${hero.accentColor}22`,
                      ...
                      >
                        <span style={{ color: "hsl(42,60%,55%)" }}>Знак: </span>
                        {hero.sign}
                      </p>
                    ...
                    <div className={i % 2 === 1 ? "md:order-1" : ""}>
                      <div
                        ...
                        style={{
                          background: `linear-gradient(135deg, ${hero.accentColor}12, hsl(150,18%,8%))`,
                          border: `1px solid ${hero.accentColor}20`,
                        }}
                      >
                        <span className="text-[140px] opacity-30">
                          {hero.emoji}
                        </span>
                        <div
        ...
        {activePage === "catalog" && (
          <section
            ...
            style={{
              background:
                "linear-gradient(180deg, hsl(35,18%,10%) 0%, hsl(35,12%,8%) 100%)",
            }}
          >
            <div className="container max-w-6xl mx-auto">
              <div className="text-center mb-20 animate-fade-in-up">
                ...
                >
                  Каждый — ручная работа. Тираж ограничен. Выбери того, кто
                  созвучен твоему состоянию прямо сейчас.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7">
                {HEROES.map((hero, i) => (
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(160deg, hsl(35,18%,14%) 0%, hsl(35,12%,11%) 100%)",
                      border: "1px solid hsl(35,18%,20%)",
                    ...
                    onMouseEnter={(e) => {
                      ...
                      (e.currentTarget as HTMLDivElement).style.boxShadow =
                        `0 20px 60px rgba(0,0,0,0.5), 0 0 0 1px ${hero.accentColor}30`;
                    }}
                    onMouseLeave={(e) => {
                      (e.currentTarget as HTMLDivElement).style.transform =
                        "translateY(0)";
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        background: `linear-gradient(145deg, hsl(35,22%,18%), hsl(35,14%,13%))`,
                      }}
                    >
                      <img
                        src={hero.image}
                    ...
                    <div className="flex flex-col flex-1 p-6">
                      ...
                      <div
                        ...
                        style={{
                          background: `${hero.accentColor}10`,
                          border: `1px solid ${hero.accentColor}22`,
                        }}
                      >
                        <Icon
                          name={hero.icon}
            ...
            <div className="container max-w-3xl mx-auto">
              ...
              {quizAnswer === null ? (
                ...
                >
                  ...
                  <div
                    className="p-10 rounded-3xl forest-card mb-8 relative overflow-hidden"
                    style={{
                      border: `1px solid ${HEROES[quizAnswer].accentColor}30`,
                    }}
                  >
                    <div
                      className="absolute top-0 left-0 right-0 h-px"
                      style={{
                        background: `linear-gradient(90deg, transparent, ${HEROES[quizAnswer].accentColor}60, transparent)`,
                      }}
                    />
                    <div className="text-8xl mb-6 inline-block animate-float">
                      {HEROES[quizAnswer].emoji}
                    </div>
                    <h2
                      className="mb-2"
                      style={{
                    ...
                    <p
                      ...
                      style={{
                        color: HEROES[quizAnswer].accentColor,
                        fontFamily: "'Golos Text', sans-serif",
                      }}
                    >
                  ...
                  <div className="flex justify-center gap-4 flex-wrap">
                    <button
                      onClick={() => addToCart(HEROES[quizAnswer])}
                ...
                {[
                  {
                    icon: "Leaf",
                    title: "Натуральность",
                    text: "Только экологичные материалы. Безопасно для детей, бережно к природе.",
                  },
                  {
                    icon: "Scissors",
                    title: "Ручная работа",
                    text: "Каждая фигурка создаётся вручную. Ни одна не похожа на другую.",
                  },
                  {
                    icon: "Heart",
                    title: "С намерением",
                    text: "В каждого хранителя вложена история, смысл и любовь мастера.",
                  },
                ].map((v, i) => (
                  <div
                    key={v.title}
                    className={`delay-${i * 200} p-6 rounded-2xl forest-card text-center`}
                  >
                    <div
            ...
            <div className="container max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-12">
                <div className="animate-fade-in-up space-y-8">
                  {[
                    ...
                    },
                    {
                      icon: "Instagram",
                      label: "Instagram",
                      value: "@little.spirits.ru",
                    },
                    {
                      icon: "MapPin",
                      label: "Россия",
                      value: "Доставка по всей стране",
                    },
                  ].map((c) => (
                ...
                <div className="animate-fade-in-up delay-200 p-8 rounded-3xl forest-card space-y-4">
                  ...
                  />
                  <button className="btn-gold w-full py-3 rounded-xl font-medium">
                    Отправить
                  </button>
                </div>
              </div>
              ...
              {orderSubmitted ? (
                ...
                <div className="grid md:grid-cols-2 gap-12">
                  ...
                  <div className="animate-fade-in delay-200">
                    ...
                    <div className="space-y-3 mb-6">
                      {cart.length === 0 ? (
                        ...
                        cart.map((item) => (
                          <div
                            key={item.id}
                            className="flex items-center justify-between p-4 rounded-xl forest-card"
                          >
                    ...
                    <div
                      className="border-t py-4 flex justify-between items-center mb-6"
                      style={{ borderColor: "rgba(212,175,55,0.1)" }}
                    >
                      <span
                        style={{
                ...
                <div className="space-y-2">
                  {col.links.map((link) => (
                    <button
                      ...
                      className="block text-sm nav-link"
                    >
                      {link.l}
                    </button>
                  ))}
